...
@__DSOCacheEntry_name.31 = internal constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 1
...
@__DSOCacheEntry_name.76 = internal constant [35 x i8] c"libaot-AjudaCertaIndustrial.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [560 x %struct.DSOCacheEntry] [
	...
	; 121
	%struct.DSOCacheEntry {
		i64 1011128092, ; hash 0x3c44971c, from name: libaot-AjudaCertaIndustrial
		i8 0, ; ignore
	...
	; 137
	%struct.DSOCacheEntry {
		i64 1125843531, ; hash 0x431b024b, from name: libaot-AjudaCertaIndustrial.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.76, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 291
	%struct.DSOCacheEntry {
		i64 2184525596, ; hash 0x8235371c, from name: AjudaCertaIndustrial.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.76, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 475
	%struct.DSOCacheEntry {
		i64 3601523975, ; hash 0xd6aae507, from name: aot-AjudaCertaIndustrial
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.76, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 547
	%struct.DSOCacheEntry {
		i64 4187961101, ; hash 0xf99f370d, from name: AjudaCertaIndustrial
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.76, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 554
	%struct.DSOCacheEntry {
		i64 4265620935, ; hash 0xfe4035c7, from name: aot-AjudaCertaIndustrial.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.76, i32 0, i32 0), ; name
		i8* null; handle
	}, 
